...
from pacman._version import _get_version_from_pyproject, get_version
...
def test_version_consistency() -> None:
    ...
    from pacman import __version__ as version1
    from pacman._version import __version__ as version2
